...
Kine::Languages::tagMap_type Exordium::CreditsModule::Language::tagMap = {[+ FOR langtag +][+ IF
   (useThisTag?) +]
   { "[+
   (string-upcase
      (sprintf "%s%s"
...
[+ == h +]
#ifndef _SOURCE_MODULES_CREDITS_LANGUAGE_H_
# define _SOURCE_MODULES_CREDITS_LANGUAGE_H_ 1
...
#endif // _SOURCE_MODULES_CREDITS_LANGUAGE_H_
[+ ESAC +]
