...
Kine::Languages::tagMap_type Exordium::ChanModule::Language::tagMap = {[+ FOR langtag +][+ IF
   (useThisTag?) +]
   { "[+
   (string-upcase
      (sprintf "%s%s"
...
# define _SOURCE_MODULES_CHAN_LANGUAGE_H_ 1
...
#endif // _SOURCE_MODULES_CHAN_LANGUAGE_H_
[+ ESAC +]
