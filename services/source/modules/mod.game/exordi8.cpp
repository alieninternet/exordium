...
players.end();
   ...
   // The balance of the cards left in the shuffled pack(s) turn into the
stock
   while (!packs.empty()) {
...
lastDiscardedCard.getColour()))) {
      ...
      // However, if this IS the first play, the queen of hearts cannot be
used
   ...
   // If the queen of spades was on the top of the discard pile, devalue
trumps
