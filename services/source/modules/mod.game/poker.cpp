 ...
 */
Poker::Poker(Exordium::GameModule::Service& module, const Kine::ChannelName& channel,
...
const Poker::functionTable_type Poker::functionTable[] =
{
     { "deal",			&Poker::parseDEAL },
     { "discard",		&Poker::parseDISCARD },
     { "drop",			&Poker::parseDISCARD },
//     { "hand",			&Poker::parseSHOWHAND },
//     { "pass",			&Poker::parsePASS },
//     { "pickup",		&Poker::parsePICKUP },
     { "play",			&Poker::parsePLAY },
//     { "showhand",		&Poker::parseSHOWHAND },
//     { "skip",			&Poker::parsePASS },
//     { "stat",			&Poker::parseSTATUS },
//     { "stats",			&Poker::parseSTATUS },
//     { "status",		&Poker::parseSTATUS },
//     { "suit",			&Poker::parseSUIT },
//     { "take",			&Poker::parsePICKUP },
     { 0, 0 }
};
 ...
 * Original 29/08/2002 pickle
 */
bool Poker::parseLine(Exordium::User& origin, String& command,
			StringTokens& tokens)
{
 ...
 */
const Poker::player_type* const
  Poker::getPlayer(const Exordium::User& player) const
{
...
Poker::player_type* const Poker::getPlayer(const Exordium::User& player)
{
   // Run through the list and find this player.. *sigh*
 ...
 */
Poker::player_type* const
  Poker::checkPlayerStatus(Exordium::User& player, bool quiet)
{
   ...
   if (playerInfo == 0)
	...
	if (!quiet)
	  {
	     sendMessage(player, "You're not playing Poker!");
	  }
	return 0;
     }
 ...
 * Original 30/08/2002 pickle
 */
void Poker::showHand(const player_type& player) const
{
 ...
 * Original 30/08/2002 pickle
 */
void Poker::nextPlayer(const String& why, bool withMatchNotify)
{
   std::ostringstream out;
   ...
   if (withMatchNotify)
	...
	// Tell the player what they need to get..
        /*
        Cards* cards = lastDiscardedCards;
...
EXORDI8_FUNC(Poker::parsePLAY)
{
   ...
   if (players.size() == maxPlayers)
	...
	sendMessage(*(players.front().first),
		    ...
		    "Poker - No more players can join the game. You must "
 ...
 * Original 30/08/2002 pickle
 */
EXORDI8_FUNC(Poker::parseDISCARD)
{
   ...
   // Okay, try to make cards which match their description or position num
   while(line.hasMoreTokens())
   {
	 ...
	 return true; // Keep the game alive
      ...
      discardList.push_back(cardToDiscard);
   }
