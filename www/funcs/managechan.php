...
echo "<form action=\"$_SERVER[PHP_SELF]\" method=\"POST\"><tr><td align=\"center\"><br><input type=\"hidden\" name=\"action\" value=\"deregchan\"><input type=\"hidden\" name=\"chan_id\" value=\"$_POST[chan_id]\"><input id=\"submit\" type=\"submit\" name=\"sub\" value=\"drop your room\"><br></td></tr></form>\n";
echo "<tr><td colspan=\"2\"><br></td></tr>";
echo "<tr id=\"header\"><td colspan=\"2\">manage your room's access</td></tr>";
echo "<form action=\"$_SERVER[PHP_SELF]\" method=\"POST\"><tr><td align=\"center\"><input type=\"hidden\" name=\"action\" value=\"listchanusers\"><input type=\"hidden\" name=\"chan_id\" value=\"$_POST[chan_id]\"><input id=\"submit\" type=\"submit\" name=\"sub\" value=\"list users\"><br></td></tr></form>\n";
